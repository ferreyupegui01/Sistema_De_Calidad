...
// Mapa de Iconos Temáticos HACCP
const ICON_MAP = {
    'folder': <FaFolder />,
    'shield': <FaShieldAlt />,       // Seguridad General
    'temp': <FaTemperatureHigh />,   // Control Temperatura (PCC común)
    'bio': <FaBiohazard />,          // Riesgos Biológicos
...
const GestionHACCP = () => {
    ...
    const handleOpenCreateACPM = (rep) => {
        setAcpmData({
            ...
            descripcion: `Desviación en límite crítico o prerrequisito: ${rep.Observaciones || 'Sin detalles'}`,
        ...
        <div className="fade-in">
            ...
            <div className="page-header">
                <div>
                    ...
                    <p style={{color:'#64748b', marginTop:'-5px'}}>Análisis de Peligros y Puntos Críticos de Control.</p>
                </div>
            </div>
            ...
            {activeTab === 'reportes' && (
                <div className="fade-in">
                    <div className="control-bar" style={{marginBottom:'20px', display:'flex', justifyContent:'space-between', flexWrap:'wrap', gap:'10px'}}>
                        ...
                        {/* AQUÍ ESTÁ LA CORRECCIÓN DE LA LUPITA */}
                        ...
                        <div style={{display:'flex', alignItems:'center', gap:'10px'}}>
                            ...
                            >
                                ...
                                <option value="fallas">Desviación PCC</option>
                                    ...
                                    <tr key={rep.ID_Reporte} className="modern-row">
                                        ...
                                        <td className="modern-cell">
                                            <div style={{display:'flex', gap:'5px', flexDirection:'column'}}>
                                                {rep.Tiene_Fallas ? 
                                                    <span className="status-pill danger"><FaExclamationTriangle/> Desviación</span> : 
